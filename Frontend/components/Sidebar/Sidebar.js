        ...
        <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          ...
          >
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              ...
              <li className="items-center">
                <Link href="/security/tables">
                  <a className={"text-xs uppercase py-3 font-bold flex items-center gap-2  " + (router.pathname.indexOf("/security/tables") !== -1 ? "text-scDark hover:text-black" : "text-black hover:text-black")}>
                    <AiOutlineTable size={"20"} />
                    Tables
                  </a>
                </Link>
